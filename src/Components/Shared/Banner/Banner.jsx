                    ...
                    <div className='text-black  font-bold lg:space-y-7 lg:w-1/2 lg:pl-12 mb-4'>
                        <div className="mt-28">
                          ...
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum, optio.
                            ...
                            <p className='text-sm p-2 md:text-4xl '>Lorem ipsum dolor sit amet.
                            </p>
                        </div>
                        ...
                        <div className="w-1/2 md:full p-4">
                            ...
                            <img className="absolute w-34 md:w-[175px] h-16 md:h-[169.89px] top-80 md:top-[359.19px] md:left-[600px] border-4 md:rotate-53-14" src="../../../../public/img -1.png" alt="" />

                            <img className="absolute w-34 md:w-[112.54px] h-24 md:h-[154.41px] top-36  md:top-10 left-80 md:left-[1137.24px] md:border-5 md:rotate--18-13" src="../../../../public/img-2.png" alt="" />
                        </div>
